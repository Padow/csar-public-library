#!/bin/bash -e
ES_PATH=$INSTALL_PATH/elasticsearch-1.7.6
...
searchguard.ssl.transport.keystore_filepath: '${ES_PATH}'/config/server-keystore.jks
searchguard.ssl.transport.keystore_password: changeit
searchguard.ssl.transport.truststore_filepath: '${ES_PATH}'/config/server-truststore.jks
